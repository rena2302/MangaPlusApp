...
public class FilterManga extends Filter {
    ...
    public FilterManga(List<TruyenTranh> truyenTranhList, TruyenTranhAdapter truyenTranhAdapter) {
    ...
    protected FilterResults performFiltering(CharSequence constraint) {
        ...
        if(constraint != null && constraint.length() > 0){
            ...
            List<TruyenTranh> filterModels = new ArrayList<>();
    ...
    protected void publishResults(CharSequence constraint, FilterResults results) {
        truyenTranhAdapter.setFilterManga((List<TruyenTranh>)results.values);
